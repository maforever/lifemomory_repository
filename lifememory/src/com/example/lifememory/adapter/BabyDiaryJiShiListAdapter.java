...
public class BabyDiaryJiShiListAdapter extends BaseAdapter {
	private Context context;
	private List<BabyJiShiBen> items = null;
	...
	public BabyDiaryJiShiListAdapter(Context context,
			List<BabyJiShiBen> jishibenItems, boolean isFirstGroup) {
