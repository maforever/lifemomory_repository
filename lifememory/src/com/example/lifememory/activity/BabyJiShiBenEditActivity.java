...
public class BabyJiShiBenEditActivity extends Activity{
...
//	private LinearLayout layout = null;
	...
	private BabyDiaryJiShiBenService dbService = null; //语气记事本数据库服务
	private BabyJiShiBen jishibenItem; //孕期记事本
	private int itemId;
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			//修改
			case 1:
				BabyJiShiBenEditActivity.this.finish();
				overridePendingTransition(R.anim.activity_steady, R.anim.activity_down);
				Toast.makeText(BabyJiShiBenEditActivity.this, "日记修改成功!", 0).show();
				break;
			}
		};
	};
...
//				dbService.updateItem(jishibenItem);
				CopyFileFromData.getInstance().copyDatabase(BabyJiShiBenEditActivity.this, "pregnancy_diary.db");
				break;
			//分享
			case 5:
				break;
			//命名
			case 6:
				new DialogPregnancyJiShiBenReNameDialog(BabyJiShiBenEditActivity.this, pj_renameDilaoglistener,"name").show();
				break;
			//另存为
			case 7:
	...
	private class UpdateThread extends Thread {
		BabyJiShiBen jishiben = null;
		public UpdateThread(BabyJiShiBen jishiben) {
