...
public class BabyJiShiBenAddActivity extends Activity{
...
//			overridePendingTransition(R.anim.activity_steady, R.anim.activity_down);
			Toast.makeText(BabyJiShiBenAddActivity.this, "保存日记成功!", 0).show();
		};
	};
	@Override
...
//			adapter.setSelected(position);
			...
			case 4:
				...
				isSave = true;
				CopyFileFromData.getInstance().copyDatabase(BabyJiShiBenAddActivity.this, "pregnancy_diary.db");
				break;
			//分享
			case 5:
				break;
	...
	private class SaveJiShiBenThread extends Thread {
		...
		public SaveJiShiBenThread(BabyJiShiBen jishiben) {
