	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				...
				Toast.makeText(BabyJiShiBenReadActivity.this, "删除日记成功!", 0).show();
				break;
			//重命名
			case 2:
				Toast.makeText(BabyJiShiBenReadActivity.this, "日记重命名成功!", 0).show();
				break;
					...
					new View.OnClickListener() {
						...
						public void onClick(View view) {
							...
							case R.id.composer_button_del:
								new DialogAlert(BabyJiShiBenReadActivity.this, listener, "您确定删除此条日记吗?").show();
								break;
